	...
	public int[] getFreqs(String[] doc) {
		...
		for (String s : doc)
			for (char c : s.toLowerCase().toCharArray())
				if (97<=c && c<=122) res[c-97]++;
		
		return res;
	}

	public static void main(String[] args) {
		LetterFreq l = new LetterFreq();
		System.out.println(Arrays.toString(l.getFreqs(new String[]{ "Be sure to ignore case", "and non-letter characters"})));
		System.out.println(Arrays.toString(l.getFreqs(new String[]{"The following table shows letter frequences","for 3 languages.",
										  ...
										  "Y      1.9%    1.16%   0.039%", 
										  "Z      1%      0.72%   1.089%"})));
		System.out.println(Arrays.toString(l.getFreqs(new String[]{ "Friends, Romans, countrymen, lend me your ears; ",
		...
		System.out.println(Arrays.toString(l.getFreqs(new String[]{ "amis, Romans, compatriotes,"," me pretent vos oreilles; ",
										  ...
										  "et je dois faire une pause jusqu'a"," ce qu'il reviennent a moi" })));
	}
}
